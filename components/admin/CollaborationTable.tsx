...
export default function CollaborationTable({ collaborations, onEdit }: { collaborations: OfficialCollaborationWithMuseum[] | null, onEdit: (name: string) => void }) {
                ...
                {collaborations.map((collaboration) => (
                    <tr key={collaboration.id} className="border-t border-neutral-800 bg-neutral-950">
                        ...
                        <td className="px-4 py-3 text-right">
                            <button
                                type="button"
                                onClick={() => onEdit(collaboration.title)}
