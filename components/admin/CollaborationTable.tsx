const COLLABORATIONS = [
    { name: "サンプルコラボ 1", updatedAt: "2026-07-01" },
    { name: "サンプルコラボ 2", updatedAt: "2026-07-01" },
    { name: "サンプルコラボ 3", updatedAt: "2026-07-01" },
];

export default function CollaborationTable({ onEdit }: { onEdit: (name: string) => void }) {
    return (
        <table className="w-full text-left text-sm">
            ...
            <tbody>
                {COLLABORATIONS.map(({ name, updatedAt }) => (
